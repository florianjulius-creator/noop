...
struct NOOPChargeView: View {
    ...
    private var accessibilityCharge: String {
        ...
        if isStale {
            ...
            return String(localized: "Charge out of date, last synced \(fresh). Open The Machine on iPhone.")
        }
        switch charge {
        ...
        case .missing:         return noSnapshot ? String(localized: "No data, open The Machine on iPhone")
    ...
    private var accessibilityRectangular: String {
        ...
        if isStale {
            let fresh = freshness ?? String(localized: "a while ago")
            return String(localized: "The Machine. Scores out of date, last synced \(fresh). Open The Machine on iPhone to refresh.")
        }
        ...
        return String(localized: "The Machine. \(chargePhrase), \(effortPhrase), \(restPhrase).")
    }
